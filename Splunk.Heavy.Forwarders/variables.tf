...
variable "resource_group" {
  ...
  default = "RG-AMS-SECOPS-SPLUNK-HF"
}
...
variable "nsg_name" {
  ...
  default     = "AMS-SECOPS-SPLUNK-HF-NSG"
}
...
variable "subnet_name" {
  description = "The name for the virtual network."
  default     = "sNET-AMS-OPS-GW-SUBNET-SPLUNK-HF"
}
...
variable "loadbalancer_name" {
  ...
  default     = "AMS-SPLUNK-HF-LB" 
}

variable "frontendip_name" {
  description = "name of front end ip configuration"
  default     = "AMS-SPLUNK-LB-FE-IP"
}